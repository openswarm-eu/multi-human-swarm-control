...
// void CWorker::SLeaderInteractionParams::Init(TConfigurationNode& t_node) {
//    try {
...
void CWorker::Init(TConfigurationNode& t_node) {
    ...
    */
    ...
    if( m_strSCTPath == "src/SCT_models/worker.yaml" ) {

        /* Register controllable events */
        sct->add_callback(this, sct->events["EV_moveFlock"], &CWorker::Callback_MoveFlock, NULL, NULL);
        sct->add_callback(this, sct->events["EV_moveChain"], &CWorker::Callback_MoveChain, NULL, NULL);
        sct->add_callback(this, sct->events["EV_moveAdjust"],  &CWorker::Callback_MoveAdjust,  NULL, NULL);
        sct->add_callback(this, sct->events["EV_taskStart"], &CWorker::Callback_TaskStart, NULL, NULL);
        sct->add_callback(this, sct->events["EV_taskStop"],  &CWorker::Callback_TaskStop,  NULL, NULL);
        sct->add_callback(this, sct->events["EV_switchF"],   &CWorker::Callback_SwitchF,   NULL, NULL);
        sct->add_callback(this, sct->events["EV_switchC"],   &CWorker::Callback_SwitchC,   NULL, NULL);
        sct->add_callback(this, sct->events["EV_switchT"],   &CWorker::Callback_SwitchT,   NULL, NULL);
        sct->add_callback(this, sct->events["EV_requestL"],  &CWorker::Callback_RequestL,  NULL, NULL);
        sct->add_callback(this, sct->events["EV_requestC"],  &CWorker::Callback_RequestC,  NULL, NULL);
        sct->add_callback(this, sct->events["EV_respond"],   &CWorker::Callback_Respond,   NULL, NULL);
        sct->add_callback(this, sct->events["EV_relay"],     &CWorker::Callback_Relay,     NULL, NULL);
        
        /* Register uncontrollable events */
        sct->add_callback(this, sct->events["EV_condC1"],    NULL, &CWorker::Check_CondC1,    NULL);
        sct->add_callback(this, sct->events["EV_notCondC1"], NULL, &CWorker::Check_NotCondC1, NULL);
        sct->add_callback(this, sct->events["EV_condC2"],    NULL, &CWorker::Check_CondC2,    NULL);
        sct->add_callback(this, sct->events["EV_notCondC2"], NULL, &CWorker::Check_NotCondC2, NULL);
        sct->add_callback(this, sct->events["EV_nearC"],     NULL, &CWorker::Check_NearC,     NULL);
        sct->add_callback(this, sct->events["EV_notNearC"],  NULL, &CWorker::Check_NotNearC,  NULL);
        sct->add_callback(this, sct->events["EV_condF1"],    NULL, &CWorker::Check_CondF1,    NULL);
        sct->add_callback(this, sct->events["EV_notCondF1"], NULL, &CWorker::Check_NotCondF1, NULL);
        sct->add_callback(this, sct->events["EV_condF2"],    NULL, &CWorker::Check_CondF2,    NULL);
        sct->add_callback(this, sct->events["EV_notCondF2"], NULL, &CWorker::Check_NotCondF2, NULL);
        sct->add_callback(this, sct->events["EV__respond"],  NULL, &CWorker::Check__Respond,  NULL);
        sct->add_callback(this, sct->events["EV_accept"],    NULL, &CWorker::Check_Accept,    NULL);
        sct->add_callback(this, sct->events["EV_reject"],    NULL, &CWorker::Check_Reject,    NULL);
        sct->add_callback(this, sct->events["EV__requestC"], NULL, &CWorker::Check__RequestC, NULL);
        sct->add_callback(this, sct->events["EV__start"],    NULL, &CWorker::Check__Start,    NULL);
        sct->add_callback(this, sct->events["EV__stop"],     NULL, &CWorker::Check__Stop,     NULL);
        sct->add_callback(this, sct->events["EV__message"],  NULL, &CWorker::Check__Message,  NULL);
        sct->add_callback(this, sct->events["EV__relay"],    NULL, &CWorker::Check__Relay,    NULL);
        sct->add_callback(this, sct->events["EV__exchange"], NULL, &CWorker::Check__Exchange, NULL);
        sct->add_callback(this, sct->events["EV_chosen"],    NULL, &CWorker::Check_Chosen,    NULL);
        sct->add_callback(this, sct->events["EV_notChosen"], NULL, &CWorker::Check_NotChosen, NULL);
        sct->add_callback(this, sct->events["EV_nearLF"],    NULL, &CWorker::Check_NearLF,    NULL);
        sct->add_callback(this, sct->events["EV_notNearLF"], NULL, &CWorker::Check_NotNearLF, NULL);
...
RobotState CWorker::GetRobotState() {
    return currentState;
}
...
Message CWorker::GetClosestNonTeam() {
...
bool CWorker::IsClosestToRobot(const Message& msg) {
...
CVector2 CWorker::GetConnectorAttractVector() {
...
void CWorker::Callback_TaskStart(void* data) {
    lastControllableAction = "taskStart";
    performingTask = true;
}

void CWorker::Callback_TaskStop(void* data) {
...
void CWorker::Callback_MoveChain(void* data) {
...
void CWorker::Callback_RequestL(void* data) {
...
unsigned char CWorker::Check__Start(void* data) {
...
unsigned char CWorker::Check__Stop(void* data) {
...
unsigned char CWorker::Check_CondC1(void* data) {
...
unsigned char CWorker::Check_NotCondC1(void* data) {
    if(connectionCandidate.direction.Length() >= separationThres) {
...
unsigned char CWorker::Check_CondC2(void* data) {
    // std::cout << "Event: " << condC2 << " - condC2" << std::endl;
    return condC2;
}

unsigned char CWorker::Check_NotCondC2(void* data) {
    // std::cout << "Event: " << !condC2 << " - notCondC2" << std::endl;
    return !condC2;
}

// unsigned char CWorker::Check_CondC3(void* data) {
//     if( !connectionCandidate.Empty()) {
...
// unsigned char CWorker::Check_NotCondC3(void* data) {
//     if( !connectionCandidate.Empty() ) {
//         if(teamID < connectionCandidate.teamID) {
...
unsigned char CWorker::Check_CondF1(void* data) {
    // std::cout << "Event: " << condF1 << " - condF1" << std::endl;
    return condF1;
}

unsigned char CWorker::Check_NotCondF1(void* data) {
    // std::cout << "Event: " << !condF1 << " - notCondF1" << std::endl;
    return !condF1;
}

unsigned char CWorker::Check_CondF2(void* data) {
    // std::cout << "Event: " << condF2 << " - condF2" << std::endl;
    return condF2;
}

unsigned char CWorker::Check_NotCondF2(void* data) {
...
unsigned char CWorker::Check_NearLF(void* data) {
    // std::cout << "Event: " << nearLF << " - nearLF" << std::endl;
    return nearLF;
}

unsigned char CWorker::Check_NotNearLF(void* data) {
