...
protected:
    ...
    *
    * Connectors have higher priority than workers from another team.
...
private:
    ...
    Message firstConnector; // The connector that a worker in the team should connect to next
    ...
    /* Workers that are within the safety range */
